...
const sharedSafety = [
  ...
  "- Stay age-appropriate; avoid explicit content;take a anti drug stance; respect privacy and consent.",
].join("\n")
...
const sessionFrame = [
  ...
  "- **First message**: If name or sport is unknown, ask for them. Then offer 2–3 example sessions from your catalog that fit the athlete’s goal.",
